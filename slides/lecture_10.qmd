...
- Residual graphs are plots of
    ...
    * Squared residuals $\hat{\e}_i^2$ against fitted values $\hat{y}_i$
...
- A tranformation which often helps with Funnelling residuals is
    * $\, \log y$
...
- Assume error variance is proportional to $X_i^2$ 
...
- Fit simple regression to the model in (1)
...
- Assume error variance is proportional to $X_i$ 
...
- Fit simple regression to the model in (2)
