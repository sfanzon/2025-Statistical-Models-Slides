...
| Lecture 11  | [Multicollinearity](slides/codes/multicollinearity.R) <br> [Stepwise regression: Longley](slides/codes/longley_stepwise.R) <br> [Stepwise regression: Divorces](slides/codes/divorces_stepwise.R)  <br> [Anova models](slides/codes/anova.R)           |
: {tbl-colwidths="[30,70]"}
