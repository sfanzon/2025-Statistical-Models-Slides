...
- In particular, the conditional pdf of $Y$ given $X = x$ is
$$
f(y|x) = 
\begin{cases}
...
- As $X$ is uniform on $(0,1)$, its pdf is
$$
f_X(x) = 
\begin{cases}
...
In gray: region where $f_{X,Y}(x,y)>0$
