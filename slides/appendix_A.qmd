...
- By assumption $Y | X = x$ is $N(x,x^2)$. Therefore
$$
\Expect[Y|X] = X \,, \qquad  
\Var[Y|X] = X^2 
$$
...
\begin{align*}
\Expect[Y] & = \Expect[ \Expect[Y|X] ] = \Expect[X] = \frac12 \\
& \phantom{s} \\
...
# Part 8: <br>Multivariate random vectors {background-color="#cc0164" visibility="uncounted"}
