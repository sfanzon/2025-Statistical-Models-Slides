...
## Longley macroeconomic dataset {.smaller}
...
- $X_2$ *GNP.deflator*: Coefficient for adjusting the Gross National Product for inflation  
($1954 = 100$, meaning that the yearly GDP has to be adjusted for inflation with reference to the last year, which is 1954)
- $X_3$ *GNP*: The yearly Gross National Product in billion dollars
- $X_4$ *Unemployed*: The number of unemployed people in 
- $X_5$ *Armed.Forces*: Number of people in the Armed Forces
- $X_6$ *Population*:  The non-institutionalised population $\geq$ age 14 (not in care of insitutions)
- $X_7$ *Year*: We have yearly data from 1947 to 1962
