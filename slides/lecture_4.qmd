...
# Lecture 4: <br>The variance ratio test <br> and... {background-color="#cc0164" visibility="uncounted"}
...
## Performing the variance ratio test {.smaller}
...
| ``dnorm(x, mean = mu, sd = sig)`` |   $f(x)$, where $f$ is density of $X$    |
