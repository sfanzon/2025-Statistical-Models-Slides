...
5. F-test for general regression
...
1. **Calculation**: Write down the design matrix $Z$ and compute
$$
(Z^T Z)^{-1} =
\left(
\begin{array}{ccc}
...
# Part 5: <br>F-test for general regression {background-color="#cc0164" visibility="uncounted"}
...
- However we can find critical values close to $F_{1,31} (0.05)$ in [Table 3](files/Statistics_Tables.pdf)
